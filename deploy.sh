#!/bin/bash
# Deploy hass-codex-usage to local Home Assistant config
set -e

SRC="$(dirname "$0")/custom_components/hass_codex_usage"
DEST="/home/trick/docker-services/hass-config/custom_components/hass_codex_usage"
